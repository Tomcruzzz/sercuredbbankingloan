<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Bank/MasterPage/Admin.master" AutoEventWireup="true" CodeFile="Credit_Deposit.aspx.cs" Inherits="Users_Bank_DebitDeposit_Deposit_Debit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="height: 100px; width: 633px;">
        ...
        <tr>
            <td colspan="2"><center><h3>Credit Card Details </h3>&nbsp;</center></td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan="2">
                <asp:Button ID="btn_Submit" runat="server" Text="Submit" OnClick="btn_Submit_Click" style="height: 26px"/>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
